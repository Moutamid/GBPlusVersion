...
import com.moutamid.gb.databinding.ActivityTextEmojiBinding;

import java.io.IOException;
import java.io.InputStream;

public class TexttEmojiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.shareBtn.setOnClickListener(v -> {
            ...
            try {
                ...
                Toast.makeText(TexttEmojiActivity.this, "Some problems", Toast.LENGTH_SHORT).show();
            }
        });
