...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.directChatBtn.setOnClickListener(v -> {
            startActivity(new Intent(this, DireectChatActivity.class));
        });

        binding.bubble.setOnClickListener(v -> {
            startActivity(new Intent(this, BlankMesssagesActivity.class));
        });

        binding.textRepeat.setOnClickListener(v -> {
            startActivity(new Intent(this, TextrRepeaterActivity.class));
        });

        binding.closedCaption.setOnClickListener(v -> {
            startActivity(new Intent(this, CcaptionsListActivity.class));
        });

        binding.magic.setOnClickListener(v -> {
            startActivity(new Intent(this, TextmMagicActivity.class));
        });

        binding.emotions.setOnClickListener(v -> {
            startActivity(new Intent(this, EmmotionsActivity.class));
        });

        binding.happy.setOnClickListener(v -> {
            startActivity(new Intent(this, TexttEmojiActivity.class));
        });
        ...
        binding.WaBusiness.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Utils.hasPermissions(MainActivity.this, Utils.permissions)) {
                    ...
                    Intent i = new Intent(MainActivity.this, StattusActivity.class);
        ...
        binding.saved.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Utils.hasPermissions(MainActivity.this, Utils.permissions)) {
                    ...
                    Intent i = new Intent(MainActivity.this, MyyStatusActivity.class);
                    startActivity(i);
                }
